...
$email->Username   = "XXXXXX@gmail.com"; // SMTP account username Will need to be modified
$email->Password   = "XXXXXXX";        // SMTP account password Will need to be modified
$email->SetFrom('XXXXXXXX@hotmail.com', 'XXXXXXXXXX');  //Will need to be modified – identifies email of sender
// $email->MsgHTML($message);
$email->SingleTo  = true;	// true allows that only one person will receive an email per array group
$email->From      = 'XXXXXXXX@hotmail.com'; //Will need to be modified – identifies email of sender
$email->FromName  = 'XXXXXXXXXXX'; //Will need to be modified – identifies email of sender
...
$destination_email_address = 'XXXXXXXXXX@yahoo.com'; // Destination address
